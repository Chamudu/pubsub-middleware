...
def print_header():
    print("   Pub/Sub Middleware - Client (T3)")
    print("-"*40)
    print()
...
def start_client(server_ip, server_port):
    ...
    try:
        ...
        if role == 'PUBLISHER':
            ...
            print("─" * 50)
            print(f"You are a PUBLISHER for topic {topic}. Type messages to broadcast.")
            ...
            print("─" * 50)
            print(f"You are a SUBSCRIBER to topic {topic}. Waiting for messages...")
